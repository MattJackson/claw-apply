...
export const EXTERNAL_ATS_PATTERNS = [
  { name: 'greenhouse',      pattern: /greenhouse\.io|grnh\.se/i },
  { name: 'lever',           pattern: /lever\.co/i },
  { name: 'workday',         pattern: /workday\.com|myworkdayjobs\.com|myworkdaysite\.com/i },
  ...
  { name: 'jobvite',         pattern: /applytojob\.com/i },
  { name: 'trakstar',        pattern: /trakstar\.com/i },
  { name: 'resumator',       pattern: /theresumator\.com/i },
  { name: 'breezy',          pattern: /breezy\.hr/i },
  { name: 'jazz',            pattern: /jazz\.co/i },
  { name: 'recruitee',       pattern: /recruitee\.com/i },
  { name: 'applicantpro',    pattern: /applicantpro\.com/i },
  { name: 'paylocity',       pattern: /paylocity\.com/i },
  { name: 'paycom',          pattern: /paycomonline\.com/i },
  { name: 'ultipro',         pattern: /ultipro\.com/i },
  { name: 'successfactors',  pattern: /successfactors\.com/i },
  { name: 'eightfold',      pattern: /eightfold\.ai/i },
  { name: 'comeet',         pattern: /comeet\.com/i },
  { name: 'gem',            pattern: /jobs\.gem\.com/i },
  { name: 'adp',            pattern: /workforcenow\.adp\.com/i },
  { name: 'dayforcehcm',    pattern: /dayforcehcm\.com/i },
];
